...
resource "google_storage_bucket" "mage_transform_bucket" {
...
resource "google_service_account" "service_account_mage" {
  account_id   = "service-account-mage-id"
...
resource "google_project_iam_member" "service-account-binding" {
  ...
  member = "serviceAccount:${google_service_account.service_account_mage.email}"
}
